...
```{r}
model <- m1
# 1. Evaluación de colinealidad y chequeos adicionales
check_collinearity(model)

# 2. Test de sobre-dispersión (si la binomial negativa es apropiada)
dispersion_test <- 1 - (sum(residuals(model, type="pearson")^2) / model$df.residual)
print(paste("Índice de sobre-dispersión:", dispersion_test))

# 3. Test de heterocedasticidad con Breusch-Pagan
bp_test <- bptest(model)
print(bp_test)

# 4. Intervalos de confianza robustos (HAC)
